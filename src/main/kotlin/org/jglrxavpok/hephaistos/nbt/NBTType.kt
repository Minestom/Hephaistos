...
enum class NBTType(private val generator: () -> MutableNBT<out Any>) {
    TAG_End({ NBTEnd }),
    TAG_Byte(::NBTByte),
    TAG_Short(::NBTShort),
    TAG_Int(::NBTInt),
    ...
    companion object {
        fun <T: MutableNBT<out Any>> getID(nbtClass: Class<T>) = when(nbtClass) {
        ...
        inline fun <reified Tag: MutableNBT<out Any>> getID() = getID(Tag::class.java)
