...
public class TestWriterLists {
    ...
    public void writeByteArray() {
        JsonElement element = writer.write(NBTByteArray.from(0xCA, 0xFE, 0xBA, 0xBE));
        assertEquals("[-54,-2,-70,-66]", element.toString());
    }

    @Test
    public void writeIntArray() {
        JsonElement element = writer.write(new NBTIntArray(0xDEAD, 0xBEEF));
        assertEquals("[57005,48879]", element.toString());
    }

    @Test
    public void writeLongArray() {
        JsonElement element = writer.write(new NBTLongArray(132456789L, 987654321L, 14785239L, 9871236540L, -1379468250549L));
