...
public class TestReaderPrimitives {
    ...
    public void readLong() {
        try(NBTGsonReader reader = NBTGsonReader.reader(new StringReader("425"))) {
    ...
    public void readByte() {
        try(NBTGsonReader reader = NBTGsonReader.reader(new StringReader("42"))) {
    ...
    public void nullShouldBeGuessedAsEmptyString() {
        try(NBTGsonReader reader = NBTGsonReader.reader(new StringReader("null"))) {
            NBT element = reader.readWithGuess();
